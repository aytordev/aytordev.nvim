...
Thank you for your interest in contributing to aytordev.nvim! This guide explains how to collaborate effectively, whether you're a human contributor or an AI-assisted tool.
...
- Browse our [issue tracker](https://github.com/aytordev/aytordev.nvim/issues)
...
2. **Clone Your Fork**
   ...
   ```bash
   git clone git@github.com:YOUR-USERNAME/aytordev.nvim.git
   cd aytordev.nvim
   ```
...
3. **Configure Remotes**
   ...
   ```bash
   git remote add upstream git@github.com:aytordev/aytordev.nvim.git
   ```
...
1. Push your changes:
   ...
   ```
2. Open a [new pull request](https://github.com/aytordev/aytordev.nvim/compare)
...
1. **Search First**
   ...
   - Search [existing issues](https://github.com/aytordev/aytordev.nvim/issues)
   - Look through [discussions](https://github.com/aytordev/aytordev.nvim/discussions)
...
💡 _Need help? [Open an issue](https://github.com/aytordev/aytordev.nvim/issues/new/choose) or join our [discussions](https://github.com/aytordev/aytordev.nvim/discussions) for support._
